...
public class XmlAttributeFields
{
	...
	public XmlAttributeFields addXmlAttributeField(String name, Field field)
	{
	...
	public XmlAttributeFields addXmlAttributesField(Field field)
	{
		field.setAccessible(true);
