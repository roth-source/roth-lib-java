package roth.lib.java.api.linode.node;

import java.util.LinkedList;

import roth.lib.java.Generic;
import roth.lib.java.api.linode.LinodeClient;
import roth.lib.java.api.linode.data.model.Node;
import roth.lib.java.api.linode.data.model.NodeConfig;
import roth.lib.java.api.linode.data.model.NodeDisk;
import roth.lib.java.api.linode.data.model.NodeIp;
import roth.lib.java.api.linode.data.model.NodeJob;
import roth.lib.java.api.linode.data.request.action.AddPrivateNodeIpRequest;
import roth.lib.java.api.linode.data.request.action.AddPublicNodeIpRequest;
import roth.lib.java.api.linode.data.request.action.BootNodeRequest;
import roth.lib.java.api.linode.data.request.action.CloneNodeRequest;
import roth.lib.java.api.linode.data.request.action.DuplicateNodeDiskRequest;
import roth.lib.java.api.linode.data.request.action.RebootNodeRequest;
import roth.lib.java.api.linode.data.request.action.ResizeNodeDiskRequest;
import roth.lib.java.api.linode.data.request.action.ResizeNodeRequest;
import roth.lib.java.api.linode.data.request.action.SetRdnsNodeIpRequest;
import roth.lib.java.api.linode.data.request.action.ShutdownNodeRequest;
import roth.lib.java.api.linode.data.request.action.SwapNodeIpRequest;
import roth.lib.java.api.linode.data.request.create.CreateNodeConfigRequest;
import roth.lib.java.api.linode.data.request.create.CreateNodeDiskFromDistRequest;
import roth.lib.java.api.linode.data.request.create.CreateNodeDiskFromScriptRequest;
import roth.lib.java.api.linode.data.request.create.CreateNodeDiskRequest;
import roth.lib.java.api.linode.data.request.create.CreateNodeRequest;
import roth.lib.java.api.linode.data.request.delete.DeleteNodeConfigRequest;
import roth.lib.java.api.linode.data.request.delete.DeleteNodeDiskRequest;
import roth.lib.java.api.linode.data.request.delete.DeleteNodeRequest;
import roth.lib.java.api.linode.data.request.get.GetNodeConfigRequest;
import roth.lib.java.api.linode.data.request.get.GetNodeDiskRequest;
import roth.lib.java.api.linode.data.request.get.GetNodeIpRequest;
import roth.lib.java.api.linode.data.request.get.GetNodeJobRequest;
import roth.lib.java.api.linode.data.request.get.GetNodeRequest;
import roth.lib.java.api.linode.data.request.update.UpdateNodeConfigRequest;
import roth.lib.java.api.linode.data.request.update.UpdateNodeDiskRequest;
import roth.lib.java.api.linode.data.request.update.UpdateNodeRequest;
import roth.lib.java.api.linode.data.response.LinodeResponse;
import roth.lib.java.api.linode.data.response.NodeConfigIdResponse;
import roth.lib.java.api.linode.data.response.NodeDiskIdResponse;
import roth.lib.java.api.linode.data.response.NodeDiskJobIdResponse;
import roth.lib.java.api.linode.data.response.NodeIdResponse;
import roth.lib.java.api.linode.data.response.NodeIpResponse;
import roth.lib.java.api.linode.data.response.NodeJobIdResponse;
