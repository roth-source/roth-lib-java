...
public enum TimeZone
{
	...
	String name;
	java.util.TimeZone javaTimeZone;
	
	TimeZone(String name)
	{
		this(name, java.util.TimeZone.getTimeZone(name));
	}
	
	TimeZone(String name, java.util.TimeZone javaTimeZone)
	{
		this.name = name;
	...
	public SimpleDateFormat getFormatter(String pattern)
	{
		...
		formatter.setTimeZone(getJavaTimeZone());
		return formatter;
	}
	...
	public static TimeZone setDefault(String value)
	{
		return setDefault(fromString(value));
	}
	
	public static TimeZone setDefault(TimeZone timeZone)
	{
		java.util.TimeZone.setDefault(timeZone.getJavaTimeZone());
		TimeZone.DEFAULT.name = timeZone.name;
		TimeZone.DEFAULT.javaTimeZone = timeZone.javaTimeZone;
		return timeZone;
	}
