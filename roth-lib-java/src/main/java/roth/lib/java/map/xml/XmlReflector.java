...
import roth.lib.java.map.xml.accessor.GetXmlAttributeNameAccessor;
import roth.lib.java.map.xml.accessor.GetXmlElementsNameAccessor;
import roth.lib.java.map.xml.accessor.GetXmlPropertyNameAccessor;
import roth.lib.java.map.xml.accessor.IsXmlAttributesAccessor;
import roth.lib.java.map.xml.annotation.XmlAttribute;
import roth.lib.java.map.xml.annotation.XmlAttributes;
import roth.lib.java.map.xml.annotation.XmlElements;
import roth.lib.java.map.xml.annotation.XmlProperty;
import roth.lib.java.map.xml.reflector.XmlAttributeReflector;
